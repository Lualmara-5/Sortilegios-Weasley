...
async function setupDatabase() {
  ...
  try {
    ...
    const productos = [
      ...
      ['Polvo peruano de oscuridad instantánea', 18, 'Crea oscuridad total al instante. Ideal para escapar o esconderse.', 'Bromas', 'https://res.cloudinary.com/delqfztgg/image/upload/v1765246004/polvo-peruano_tjsytp.png0', 5],
